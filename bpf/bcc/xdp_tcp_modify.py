...
parser.add_argument("-s", "--src", help="TCP flow source IP address")
parser.add_argument("-d", "--dest", help="TCP flow destination IP address")
parser.add_argument("--sport", help="TCP flow source port")
parser.add_argument("--dport", help="TCP flow destination port")
